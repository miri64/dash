...
indefinitely, producing non-interactive output.\todo{Maybe mention that there is already a somewhat interactive shell.} The focus, as described
in section \ref{sub:Motivation}, is primarily to provide an execution
environment for shell scripts as a lightweight alternative to compiling
and flashing full-fledged C applications.
